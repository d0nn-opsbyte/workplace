...
router.get('/', requireAuth, requireJobSeeker, async (req: Request, res: Response): Promise<void> => {
  try {
...
router.delete('/:id', requireAuth, requireJobSeeker, async (req: Request, res: Response): Promise<void> => {
  try {
